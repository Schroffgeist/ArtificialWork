...
\graphicspath{{sage-plots-for-template.tex/Logos/}} % Specifies the directory for images.
...
\DTMlangsetup[english]{} % Changed to English for template
...
\fancypagestyle{vladoddstyle}{
  ...
  \fancyfoot[LE]{\textcolor{blue}{ID: \StudentId}}
  ...
  \fancyfoot[RO]{\textcolor{blue}{ID: \StudentId}}
...
\title{\vspace{-21pt} \hspace*{08pt}
				\begin{minipage}[t][00pt][c]{4.1cm}\hspace*{-15pt}
					\includegraphics[width=\linewidth]{University-Logo-Blue}
				\end{minipage}\hfill
				\begin{minipage}[t][00pt][t]{11cm}
					\centering \vspace{-34pt}
					{\large \textbf{[University Name].}}\\ \vspace{05pt}
					{\normalsize \textbf{[Faculty/School Name].}\\ \vspace{05pt}
								[Division Name].\\ \vspace{-04pt}
								[Degree Program].}
				\end{minipage}\hfill
				\begin{minipage}[c][01.7cm][c]{4.1cm}
					\includegraphics[width=\linewidth]{Faculty-Logo-Blue}
				\end{minipage}
...
$\-$ \vspace{08cm}	\\
				...
				\begin{minipage}[c][03.4cm][t]{07.5cm}
					...
					\begin{itemize}
						\item \SubjectName
						\begin{itemize}
							\item[\scalebox{0.41}{$\blacksquare$}] Group: \GroupId
							\item[\scalebox{0.41}{$\blacksquare$}] Classroom: \Classroom\vspace{00pt}
							\end{itemize}
					\end{itemize}
					{\textbf{Instructor:}}
					\begin{itemize}
						\item Prof. \ProfName
						\item Asst. \AssistantName
					\end{itemize}
				\end{minipage}
					\hspace{03mm}
				...
				\begin{itemize}
				  \item \StudentName
				    \begin{itemize}
							\item[\scalebox{0.41}{$\blacksquare$}] ID: \StudentId
							\item[\scalebox{0.41}{$\blacksquare$}] Email: \href{mailto:\StudentEmailOne}{\StudentEmailOne}
							\item[\scalebox{0.41}{$\blacksquare$}] Email: \href{mailto:\StudentEmailTwo}{\StudentEmailTwo} \vspace{-03pt}
							\end{itemize}
						\vspace{05pt}
				\end{itemize}
				{\textbf{Due Date:}}
			...
			\date{\texttt{ \GPSlocation$\-$ at \DTMcurrenttime h UTC \DTMcurrentzone\space on \today.}}
}
